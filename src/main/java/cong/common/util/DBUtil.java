...
public class DBUtil {
     ...
     * @return 指定对象的列表
     */
    public static <T> List<T> getBeanListFromResultSet(ResultSet resultSet,
                                                            Class<T> clazz) {
     ...
     */
    public static List<Map<String, Object>> getMapListFromResultSet(ResultSet resultSet) {
     ...
     */
    public static List<Object[]> getObjectArrayListFromResultSet(ResultSet resultSet) {
