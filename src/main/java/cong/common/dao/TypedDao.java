...
public class TypedDao<T> extends BaseDao {
    ...
    public List<T> queryByField(String columnName, Object fieldValue) {
    ...
    public List<T> queryByPageMySQL(int pageNum, int pageSize) {
        return queryByPageMySQL(this.clazz, pageNum, pageSize);
    }

    public List<T> queryByPageMySQL(int pageNum, int pageSize, String whereClause, Object... params) {
        return queryByPageMySQL(this.clazz, pageNum, pageSize, whereClause, params);
    }

    public List<T> queryBySQLWhereClause(String whereClause, Object... params) {
